...
var routes = [
    ...
    // {path: '/register', name: 'register', component: r=>require(['@/components/register'], r), meta: {requireAuth: true}},
    {
        path: '/register',
        name: 'register',
        component: r => require.ensure([], () => r(require('@/components/register'))),
        meta: {keepAlive: true},
        beforeLeave(to, from) {
            console.log('test11111',from)
        }
    },
...
routes = routes.concat([
    ...
    {
        path: '/transitions/customclass',
        name: 'customclass',
        component: r => require(['@/components/transitions/customclass'], r)
    },
])
